...
% h use endash no preceding space
 ...
 \begin{section}{Comparison of ILC and CLIC}
     ...
     \begin{subsection}{Timeline}
         \input{sections/CompareTimeline}
     \end{subsection}
 ...
 \begin{section}{Tables}
    ...
    \input{sections/AppendixTables} 
 \end{section}
 
 \begin{section}{Interviews}
     \input{sections/AppendixTranscripts}
 \end{section}
 
 \begin{section}{Minutes}
     \input{sections/Minutes}
 \end{section}

\begin{section}{Agendas}
     \input{sections/Agendas}
 \end{section}
