...
\begin{tabularx}{\textwidth}{X | c | c | c}
    ...
    Normalised Horizontal Emittance & $10^5$ nm   & $7 \times 10^6$ nm & 500 nm                   \\
    Normalised Vertical Emittance & $10^5$ nm   & $7 \times 10^6$ nm & 5 nm                     \\
\end{tabularx}
}
